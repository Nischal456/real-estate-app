...
export function HeroSection() {
  ...
  return (
    <section 
      className="relative h-[65vh] flex items-center justify-start text-gray-800"
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1605276374104-5de67d60924f?q=80&w=2070&auto=format&fit=crop')",
          ...
          <div className="bg-white p-4 rounded-lg shadow-2xl">
            <div className="flex border-b mb-4">
              <button 
                ...
                className={`px-6 py-2 font-semibold transition-colors ${activeTab === 'buy' ? 'border-b-2 border-[#3fa8e4] text-[#3fa8e4]' : 'text-gray-500 hover:text-[#3fa8e4]'}`}
              >
                Buy
              </button>
              <button 
                onClick={() => setActiveTab('rent')}
                className={`px-6 py-2 font-semibold transition-colors ${activeTab === 'rent' ? 'border-b-2 border-[#3fa8e4] text-[#3fa8e4]' : 'text-gray-500 hover:text-[#3fa8e4]'}`}
              >
                Rent
              </button>
            </div>
            ...
            <form onSubmit={handleSearch} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-center">
                ...
                <Button type="submit" className="bg-[#3fa8e4] hover:bg-[#3fa8e4]/90 w-full flex items-center justify-center p-3 h-full">
