        ...
        <div className="container mx-auto max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="hidden md:flex flex-col justify-center p-12 text-white relative overflow-hidden">
            ...
            <motion.div className="relative z-10" variants={containerVariants} initial="hidden" animate="visible">
              <motion.h1 variants={itemVariants} className="text-5xl font-extrabold leading-tight text-shadow-lg">
                Welcome Back!
              </motion.h1>
              ...
              >
                <motion.div variants={itemVariants}>
                  ...
                  <p className="text-center text-gray-500 mb-6">
                    {isLogin ? 'Sign in to your account' : 'Join us and find your dream home'}
                  </p>
                </motion.div>
                  ...
                  <motion.div variants={itemVariants} className="relative">
                    ...
                    {isLogin && (
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-gray-500 hover:text-[#3fa8e4]"
                      >
                        Forgot?
                      </button>
                    )}
                ...
                <motion.div variants={itemVariants} className="text-center mt-6">
                  <button
                    ...
                    className="text-sm text-[#3fa8e4] hover:underline font-semibold"
                  >
